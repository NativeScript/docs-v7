...
``` JavaScript
var virtualArray = require("virtual-array");
```
### Handle "itemsLoading" event to load items on demand using load() method.
``` JavaScript
var array = new virtualArrayDef.VirtualArray(100);
array.loadSize = 15;

array.on(virtualArrayDef.knownEvents.itemsLoading, function (args) {
...
array.on(virtualArrayDef.knownEvents.change, function (args) {
