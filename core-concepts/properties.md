...
* Change notification: Another callback function is called when the property value changes. It is called with an [EventData](/api-reference/interfaces/_data_observable_.eventdata.html) as parameter.
...
Only classes that derive from [DependencyObservable](/api-reference/classes/_ui_core_dependency_observable_.dependencyobservable.html) can have a dependency property. This class has built-in methods that support the entire infrastructure of dependency properties.
