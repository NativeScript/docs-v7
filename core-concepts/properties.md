...
* Change notification&mdash;Another callback function is called when the property value changes. It is called with an [EventData](http://docs.nativescript.org/ApiReference/data/observable/EventData.md) as parameter.
...
Only classes that derive from [DependencyObservable](http://docs.nativescript.org/ApiReference/ui/core/dependency-observable/DependencyObservable.md) can have a dependency property. This class has built-in methods that support the entire infrastructure of dependency properties.
