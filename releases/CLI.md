...
### Breaking
* Minimum required Android Build-tools version is set to 23.0.3 due to some changes in Android SDK. CLI will not allow building your application for Android in case you do not have at least this version installed.
