...
> **TIP**: A number of other templates are available to use with the `--template` option, including TypeScript templates and more. Refer to [the full list of official templates](https://market.nativescript.org/?tab=templates&category=all_templates) at any time.
