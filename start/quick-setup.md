...
> * If you're on Windows and receive an admin privileges error, please visit this page on launching the command prompt as an admin: https://technet.microsoft.com/en-us/library/cc947813(v=ws.10).aspx
