...
Your project is truly blank and this is why it appears blank or even black on the device screen. To change this, you need to add user interface to your app.

## Add User Interface

NativeScript project consist of pages. In this project, your home page is declared in `app` &#8594; `main-page.xml`. 
